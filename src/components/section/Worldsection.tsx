...
//       image: image7,
//       link: "https://docs.worldads.io/the-worldads-model/get-seen",
//       extraData: [
//         {
...
//         {/* Right Column with Swiper Carousel */}
//         <div className="rounded-[60px] border-2 h-full xl:h-[811px] hidden lg:flex flex-col px-10 xl:px-16 pt-10 items-start border-gray-100 overflow-y-auto w-full">
//           <Swiper
//             modules={[Pagination, A11y]}
//             pagination={{ clickable: true }}
//             onSlideChange={(swiper) => setActiveButton(swiper.activeIndex + 1)}
//             onSwiper={(swiper) => swiper.slideTo(activeButton - 1)}
//             className="w-full h-full"
//           >
//             {sections.map((section) => (
//               <SwiperSlide key={section.id}>
//                 <div className="flex ml-6 flex-col items-start w-full">
